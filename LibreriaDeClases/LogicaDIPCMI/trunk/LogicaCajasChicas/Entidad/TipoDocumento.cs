...
//                                        AND a.TipoDocumento <> 'Z6'";
            ...
            string sql = @"SELECT a.IdTipoDocumento, TipoDocumento, Descripcion, a.Alta, a.UsuarioAlta, a.FechaCreacion, a.UsuarioModificacion, a.FechaModificacion
                            FROM TipoDocumento AS a
                            WHERE a.Alta = 1 
                            AND a.TipoDocumento <> 'Z6'
                            AND a.Pais =  LEFT(@dominio,2)";
