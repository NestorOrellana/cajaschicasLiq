    ...
    public partial class CuentasContables : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                this.ReportViewer1.ServerReport.ReportPath = "/IP/Intermedia/RegistroFacturasWEB/CuentaContable";
                //this.ReportViewer1.ServerReport.ReportPath = "/RegistroFacturasWEB/CuentaContable";
