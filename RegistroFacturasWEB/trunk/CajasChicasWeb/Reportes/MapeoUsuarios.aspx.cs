...
{
    public partial class MapeoUsuarios : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    this.ReportViewer1.ServerReport.ReportPath = "/IP/Intermedia/RegistroFacturasWEB/MapeoUsuarios";
                    //this.ReportViewer1.ServerReport.ReportPath = "/RegistroFacturasWEB/MapeoUsuarios";
