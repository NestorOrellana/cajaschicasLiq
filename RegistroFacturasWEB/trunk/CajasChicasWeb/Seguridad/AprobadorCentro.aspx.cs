...
namespace RegistroFacturasWEB.Seguridad
{
    public partial class AprobadorCentro : System.Web.UI.Page
    {
        ...
        {
            if (ddlOrdenCompra.SelectedValue != "0")
                ddlOrdenCompra.SelectedValue = "0";
            txtCeco.Text = ddlCentroCosto.SelectedValue.ToString();
        }
        ...
        private void CargarDDLCentroCosto(string codSociedad)
        {
            GestorSociedad gestorSociedad = null;
            ...
            try
            {
                ...
                List<LlenarDDL_DTO> _listacentrocostsoDto = gestorSociedad.ListarCentroCostoDDL(codSociedad);
                ddlCentroCosto.Items.Clear();
                ddlCentroCosto.Items.Add(new ListItem("::ELIJA UNA OPCION::", "0"));
        ...
        private void CargarDDLOrdenCompra(string codSociedad)
        {
            GestorSociedad gestorSociedad = null;
            ...
            try
            {
                ...
                List<LlenarDDL_DTO> _listaOrdenCompraDto = gestorSociedad.ListarOrdenCostoDDL(codSociedad);
                ddlOrdenCompra.Items.Clear();
                ddlOrdenCompra.Items.Add(new ListItem("::ELIJA UNA OPCION::", "0"));
        ...
        private void LimpiarControles()
        {
            ...
            ddlCentroCosto.DataValueField = "0";
            ddlOrdenCompra.DataValueField = "0";
        ...
        {
            string Kostl, aufnr;
            if (ddlCentroCosto.SelectedValue == "0") Kostl = ""; else Kostl = ddlCentroCosto.SelectedValue;
            if (ddlOrdenCompra.SelectedValue == "0") aufnr = ""; else aufnr = ddlOrdenCompra.SelectedValue;
        ...
        private void CargarAprobadorCentroEdicion(GridViewCommandEventArgs e)
        {
            ...
            try
            {
                ...
                if (fila.Cells[3].Text == "&nbsp;") hfIdCentroCosto.Value = "0"; else hfIdCentroCosto.Value = HttpUtility.HtmlDecode(fila.Cells[3].Text);
                if (fila.Cells[4].Text == "&nbsp;") hfIdCentroCompra.Value = "0"; else hfIdCentroCompra.Value = HttpUtility.HtmlDecode(fila.Cells[4].Text);
        ...
        private void AlmacenaAprobadorCentro()
        {
            ...
            string cecosIncorrectos = string.Empty;
            int cantidad = 0;
            ...
            try
            {
                ...
                txtCeco.Text = txtCeco.Text.Replace(" ", "");
                txtOrden.Text = txtOrden.Text.Replace(" ", "");

                if ((txtCeco.Text != "") && (txtCeco.Text != "0"))
                cecosIncorrectos =     gestoraprobadores.BuscarCeco(txtCeco.Text, ddlSociedad.SelectedValue.ToString());
                else
                    txtCeco.Text = ddlCentroCosto.SelectedValue.ToString();

                if ((txtOrden.Text != "") && (txtOrden.Text != "0"))
                    cecosIncorrectos = gestoraprobadores.BuscarOrden(txtOrden.Text, ddlSociedad.SelectedValue.ToString());
                else 
                    txtOrden.Text = ddlOrdenCompra.SelectedValue.ToString();

                string[] CantCecos = txtCeco.Text.Split(',');
                string[] CantOrden = txtOrden.Text.Split(',');

                if (cecosIncorrectos == "")
                {
                    if ((txtCeco.Text != "") && (txtCeco.Text != "0"))
                    {
                        cantidad = CantCecos.Length;
                        for (int i = 0; i < cantidad; i++)
                        {
                            ddlCentroCosto.SelectedValue = CantCecos[i].Trim();
                    ...
                    else if ((txtOrden.Text != "") && (txtOrden.Text != "0"))
                    {
                        cantidad = CantOrden.Length;
                        for (int i = 0; i < cantidad; i++)
                        {
                            cantidad = CantOrden.Length;
                            ddlOrdenCompra.SelectedValue = CantOrden[i];
                            CargarObjetoAprobadorCentro(ref _aprobadorcentroDto);
                            gestoraprobadores.AlmacenarAprobadorCentro(_aprobadorcentroDto);
                            hfIdAprobadorCentro.Value = _aprobadorcentroDto.ID_APROBADORCENTRO.ToString();
                            DesplegarAviso("Aprobador Centro Almacenada Correctamente");
                    ...
                    DesplegarError("Los Centros / Ordenes de Costo no existen: " + cecosIncorrectos.ToString());
                CargarAprobadorCentroGrid();
                //txtCeco.Text = "";
                //txtOrden.Text = "";
        ...
        private void DarBajaAprobadorCentro(GridViewCommandEventArgs e)
        {
            ...
            try
            {
               ...
               // gestoraprobadores.DarBajaAprobadorCentro(Convert.ToInt16(fila.Cells[1].Text), usuario);
                gestoraprobadores.DarBajaAprobadorCentro(Convert.ToInt32(fila.Cells[1].Text), usuario);
        ...
        private void DarAltaAprobadorCentro(GridViewCommandEventArgs e)
        {
            ...
            {
                gestoraprobadores = Gestoraprobadores();
                gestoraprobadores.DarAltaAprobadorCentro(Convert.ToInt32(fila.Cells[1].Text), usuario);
        ...
        private string ValidarDatos()
        {
            ...
            {
                if ((txtCeco.Text == "") && (txtOrden.Text == ""))
                mensaje += "Debe seleccionar un centro de costo o una orden de compra. <br>";
            }
