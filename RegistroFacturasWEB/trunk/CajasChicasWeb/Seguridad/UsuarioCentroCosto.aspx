<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true"
    CodeBehind="UsuarioCentroCosto.aspx.cs" Inherits="RegistroFacturasWEB.Seguridad.UsuarioCentroCosto"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="CentrarDiv" style="background-color: White; width: 950px">
        ...
        <div style="float: left; padding-bottom: 8px;">
            ...
            <div style="float: left; padding-left: 8px;">
                <asp:TextBox ID="txtCentroCosto" runat="server" Width="350px"></asp:TextBox>
            </div>
        </div>
        <br />
