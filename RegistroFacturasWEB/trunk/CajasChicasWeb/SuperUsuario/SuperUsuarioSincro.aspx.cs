    ...
    public partial class SuperUsuarioSincro : System.Web.UI.Page
    {
        ...
        private void CargarDatosSincro(SuperUsuarioDTO superUsuarioDto)
        {
            if (superUsuarioDto != null)
            {
                ...
                lblNSerie.Text = string.Concat(lblNSerie.Text, superUsuarioDto.Serie);
                hlblNSerie.Text = superUsuarioDto.Serie.ToString();
                DatosSincro(true);
            }
            else {
        ...
        private void CargarDDLSociedad(string usuario)
        {
            ...
            try
            {
                ...
                List<LlenarDDL_DTO> _listaSociedadCentroDto = gestorSeguridadL.ListaSociedadUsuario(usuario);
            ...
            {
                if (gestorSeguridadL != null) gestorSeguridadL.Dispose();
            }
        }
        #endregion
