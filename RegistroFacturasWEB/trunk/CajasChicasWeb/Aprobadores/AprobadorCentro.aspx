<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true"
    CodeBehind="AprobadorCentro.aspx.cs" Inherits="RegistroFacturasWEB.Aprobaciones.AprobadorCentro"
    ...
    <script type="text/javascript">
       ...
       $(document).ready(function () {
            ...
            function CargarCentroCompra(response) {
                ...
                //Append default option
                ddlOrdenCompra.attr('disabled', false).append($('<option></option>').attr('value', 0).text('::Seleccione centro compra::'));
                var doc = $('<div></div>');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="CentrarDiv" style="background-color: White; width: 950px;">
        <div style="float: left; width: 450px; padding-left: 54px">
            <div style="float: left; margin-top: 10px; padding-left: 8px;">
                ...
                <asp:TextBox ID="txtUsuario" name="txtUsuario" Enabled = "false" runat="server" Style="width: 280px;"></asp:TextBox>
            </div>
        </div>
        <br />
    ...
    <div class="CentrarDiv" style="width: 1000px;">
        <asp:GridView ID="gvAprobadorCentro" runat="server" AutoGenerateColumns="false" EmptyDataText="No hay registros."
            ...
            onpageindexchanging="gvAprobadorCentro_PageIndexChanging" PageSize="4">
            <Columns>
