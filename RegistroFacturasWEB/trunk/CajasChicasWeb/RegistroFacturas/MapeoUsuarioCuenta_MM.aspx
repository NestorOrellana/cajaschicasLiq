<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true"
    CodeBehind="MapeoUsuarioCuenta_MM.aspx.cs" Inherits="RegistroFacturasWEB.RegistroFacturas.MapeoUsuarioCuenta_MM"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField ID="hfIdCentro" runat="server" Value="2800" />
    <asp:HiddenField ID="hfSociedad" runat="server" Value="0" />
    <div class="TituloCaja">
        <div class="TituloPagina">
            Mapeo Usuario Cuenta de Gasto
        </div>
    </div>
        ...
        <div style="float: right; padding-bottom: 8px; padding-right: 5px;">
            <div style="float: left; padding-left: 5px;">
                <asp:Button ID="btnVisualizar" class="btn btn-primary" runat="server" Text="Visualizar"
                    OnClick="btnVisualizar_Click" OnClientClick="Validar()"/>
            </div>
    ...
    <div class="CentrarDiv" style="width: 550px;">
        <asp:GridView ID="gvMapeo" runat="server" AutoGenerateColumns="False" EmptyDataText="No hay Asignaciones."
            ...
            <Columns>
                ...
                <asp:BoundField DataField="SAKNR" HeaderText="CUENTA" />
                <asp:BoundField DataField="TXT50" HeaderText="DESCRIPCION" />
