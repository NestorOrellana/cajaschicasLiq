...
{
    public partial class MapeoUsuarioCuenta_MM : System.Web.UI.Page
    {
       ...
       // string dominio;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                //ddlSociedad.SelectedValue = sociedad;
        ...
        //{
        //    CargarSociedadDDL(txtUsuario.Text);
        //}
        ...
        private void AltaCuentaUsuario(GridViewCommandEventArgs e)
        {
            ...
            try
            {
                ...
                gestorseguridad.AsignacionCuentaUsuario(fila.Cells[1].Text, txtUsuario.Text, fila.Cells[2].Text);
        ...
        private void BajaCuentaUsuario(GridViewCommandEventArgs e)
        {
            ...
            {
                gestorseguridad = GestorSeguridad();
                gestorseguridad.QuitarCuentaUsuario(fila.Cells[1].Text, txtUsuario.Text, fila.Cells[2].Text);
        ...
        public void CargarMapeoUsuarioCuentaGrid()
        {
            ...
            string SocSelect = hfSociedad.Value;
            ...
            {
                gestorSeguridad = GestorSeguridad();
                gvMapeo.DataSource = (from mapeo in gestorSeguridad.ListaUsuarioCuenta(sociedad, usuarioB, busqueda, dominio)
                                      select new
                                      {
                                          Numero = x++,
