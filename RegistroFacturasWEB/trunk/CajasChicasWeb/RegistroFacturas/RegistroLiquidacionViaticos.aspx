<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true"
    CodeBehind="RegistroLiquidacionViaticos.aspx.cs" Inherits="RegistroFacturasWEB.RegistroFacturas.RegistroLiquidacionViaticos"
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="CentrarDiv" style="background-color: White; height: 260px;">
        ...
        <div style="float: left; width: 360px; padding-left: 1px">
            <div style="float: left; margin-top: 10px; padding-left: 2px;">
                <asp:Label ID="lblExcepcion" runat="server" Text="Excepci&oacute;n:"></asp:Label>
                <asp:CheckBox ID="chExcepcion" runat="server" OnCheckedChanged="chExcepcion_CheckedChanged" />
                <asp:TextBox ID="txtExcepcion" runat="server" Enabled="false" Width="202px" OnKeyUp="ValidarNumero(this)"></asp:TextBox>
            </div>
        </div>
    ...
    <div class="CentrarDiv">
        ...
        <asp:GridView ID="gvDetalleFactura" runat="server" AutoGenerateColumns="false" CellPadding="4">
            <Columns>
                ...
                <asp:TemplateField HeaderText="PERSONAS" ItemStyle-HorizontalAlign="Center">
                    <ItemTemplate>
                        <!--<asp:TextBox ID="txtCantidad" runat="server" OnKeyUp="ValidarNumero(this)" Width="60px"
                            Text='<%# Bind("cantidad") %>'></asp:TextBox>-->
                        <asp:TextBox ID="txtPersonas" runat="server" OnKeyUp="ValidarNumero(this)" Width="60px"
                            Text='<%# Bind("cantidad") %>'></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
