<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true"
    CodeBehind="Usuarios.aspx.cs" Inherits="RegistroFacturasWEB.Mantenimientos.Usuarios" %>
            ...
            $(document).ready(function () {
                $("#form1").validate({
                    rules: {
                        ...
                        '<%=txtUsuario.UniqueID %>': { required: true, maxlength: 10 },
                    ...
                    messages: {
                        ...
                        '<%=txtUsuario.UniqueID %>': { required: "* Ingrese Usuario", maxlength: "*El Usuario debe de contener menos de 10 caracteres" },
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="CentrarDiv" style="width: 900px;">
        <%--</ContentTemplate>
        </asp:UpdatePanel>--%>
        <asp:GridView ID="gvUsuario" runat="server" AutoGenerateColumns="False" EmptyDataText="No hay Usuarios."
            CellPadding="4" AllowPaging="True" OnRowCommand="gvUsuario_RowCommand" 
