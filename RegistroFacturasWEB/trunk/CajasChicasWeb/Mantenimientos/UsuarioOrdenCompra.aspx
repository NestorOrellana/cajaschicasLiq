<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true"
    CodeBehind="UsuarioOrdenCompra.aspx.cs" Inherits="RegistroFacturasWEB.Mantenimientos.UsuarioOrdenCompra"
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //Uri WebServices
            var ajaxUrlForChild1 = '../../RegistroFacturas/MapeoUsuariosCentros.asmx/ListarOrdenCostoDDL';
            ...
            ddlOrdenCosto.bind('change', ddlCentroCostoChange);
            ...
            function ddlSociedadChange() {
                ...
                hfIdCentro.val('0');
                OcultarMensajes();
                doAjaxCall(ajaxUrlForChild1, '{codigoSociedad: ' + ddlSociedad.val() + '}', CargarOrdenCosto);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="CentrarDiv" style="background-color: White; width: 560px;">
        ...
        <div style="float: left; padding-bottom: 8px;">
            ...
            <div style="float: left; padding-bottom: 8px;">
                ...
                <div style="float: left; padding-left: 8px;">
                    <asp:DropDownList ID="ddlOrdenCosto" runat="server" Width="350px">
                    </asp:DropDownList>
                </div>
            </div>
            <br />
    ...
    <div class="CentrarDiv" style="width: 950px;">
        <asp:GridView ID="gvUsuarioOrdenCompra" runat="server" AutoGenerateColumns="False"
            EmptyDataText="No hay Datos." CellPadding="4" AllowPaging="True" OnRowCommand="gvUsuarioOrdenCompra_RowCommand"
            onpageindexchanging="gvUsuarioOrdenCompra_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="NUMERO" HeaderText="No." />
                <asp:BoundField DataField="ID_USUARIO_ORDEN_COMPRA" HeaderText="ID_USUARIO_ORDEN_COMPRA"
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton runat="server" ID="imgAlta" CommandName="Agregar" ImageUrl="~/Images/up_arrow.png"
                            CommandArgument='<%# DataBinder.Eval(Container,"RowIndex") %>' ToolTip="Dar alta orden costo usuario" />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton runat="server" ID="imgBaja" CommandName="Quitar" ImageUrl="~/Images/down_arrow.png"
                            CommandArgument='<%# DataBinder.Eval(Container,"RowIndex") %>' ToolTip="Dar baja orden costo usuario" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
