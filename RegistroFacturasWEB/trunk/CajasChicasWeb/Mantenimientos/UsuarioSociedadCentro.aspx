<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true"
    CodeBehind="UsuarioSociedadCentro.aspx.cs" Inherits="RegistroFacturasWEB.Mantenimientos.UsuarioSociedadCentro"
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function ddlSociedadChange() {
                ...
                hfIdCentro.val('0');
                OcultarMensajes();
                doAjaxCall(ajaxUrlForChild, '{codigoSociedad: ' + ddlSociedad.val() + '}', CargarCentro);
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="CentrarDiv" style="width: 950px;">
        <asp:GridView ID="gvUsuarioOrdenCompra" runat="server" AutoGenerateColumns="False"
            EmptyDataText="No hay Datos." CellPadding="4" AllowPaging="True"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="CODIGO_SOCIEDAD" HeaderText="CDIGO SOCIEDAD" HeaderStyle-CssClass="Oculto"
                    FooterStyle-CssClass="Oculto" ItemStyle-CssClass="Oculto" />
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton runat="server" ID="imgAlta" CommandName="Agregar" ImageUrl="~/Images/up_arrow.png"
                            CommandArgument='<%# DataBinder.Eval(Container,"RowIndex") %>' ToolTip="Dar alta la sociedad centro usuario" />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton runat="server" ID="imgBaja" CommandName="Quitar" ImageUrl="~/Images/down_arrow.png"
                            CommandArgument='<%# DataBinder.Eval(Container,"RowIndex") %>' ToolTip="Dar baja la sociedad centro usuario" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
