<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true"
    CodeBehind="NivelLiquidacion.aspx.cs" Inherits="RegistroFacturasWEB.Mantenimientos.NivelLiquidacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:HiddenField ID="hfCodigoNivel" runat="server" Value="0" />
    <div class="TituloCaja">
        <div class="TituloPagina">
            Mantenimiento de Niveles para Liquidaciones
        </div>
    </div>
    ...
    <div class="CentrarDiv" style="background-color: White; width: 560px;">
        ...
        <div style="float: left; padding-bottom: 8px;">
            ...
            <input type="text" id="txtNivel" class="mayuscula" runat="server" />
        </div>
        <br />
        <div style="float: left; padding-bottom: 8px;">
            <div style="float: left; width: 180px;">
    ...
    <div class="CentrarDiv" style="width: 1100px;">
        <asp:GridView ID="gvNiveles" runat="server" AutoGenerateColumns="False" EmptyDataText="No hay registros"
            CellPadding="4" GridLines="None" AllowPaging="True" OnRowCommand="gvNiveles_RowCommand"
            OnPageIndexChanging="gvNiveles_PageIndexChanging">
            <Columns>
                <asp:BoundField DataField="CODIGO_NIVEL" HeaderText="C&Oacute;DIGO KILOMETRAJE" />
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton runat="server" ID="imgBaja" CommandName="Baja" ImageUrl="~/Images/down_arrow.png"
                            CommandArgument='<%# DataBinder.Eval(Container,"RowIndex") %>' ToolTip="Dar baja nivel de liquidacion" />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:ImageButton runat="server" ID="imgAlta" CommandName="Alta" ImageUrl="~/Images/up_arrow.png"
                            CommandArgument='<%# DataBinder.Eval(Container,"RowIndex") %>' ToolTip="Dar alta nivel de liquidacion" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
