<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true"
    CodeBehind="UsuarioRol.aspx.cs" Inherits="RegistroFacturasWEB.Mantenimientos.UsuarioRol" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="CentrarDiv" style="background-color: White; width: 560px;">
        ...
        <div style="float: left; padding-bottom: 5px;">
            ...
            <div style="float: left; width: 180px;">
                <asp:GridView ID="gvRol" runat="server" AutoGenerateColumns="False" EmptyDataText="No hay Datos."
                    CellPadding="4" GridLines="None" AllowPaging="True" PageSize="10">

                    <Columns>
                        <asp:BoundField DataField="ID" HeaderText="ID" HeaderStyle-CssClass="Oculto" FooterStyle-CssClass="Oculto"
                            ItemStyle-CssClass="Oculto" />
                        <asp:BoundField DataField="ROL" HeaderText="ROL" />
                        <asp:TemplateField HeaderText="SELECCI&Oacute;N" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:CheckBox ID="idAlta" runat="server" Style="position: static" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
    ...
    <div class="CentrarDiv" style="width: 950px;">
        <asp:GridView ID="gvUsuarioRol" runat="server" AutoGenerateColumns="False" EmptyDataText="No hay Datos."
            CellPadding="4" AllowPaging="True" OnRowCommand="gvUsuarioRol_RowCommand"
            onpageindexchanging="gvUsuarioRol_PageIndexChanging" PageSize="10">
            <Columns>
